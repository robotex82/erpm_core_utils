...
require "erpm/core_utils/version"

# Describe your gem and declare its dependencies:
Gem::Specification.new do |s|
  s.name        = "erpm_core_utils"
  s.version     = ERPM::CoreUtils::VERSION
  s.authors     = ["Roberto Vasquez Angel"]
  s.email       = ["roberto@vasquez-angel.de"]
  s.homepage    = "https://github.com/robotex82/erpm_core_utils"
  s.summary     = "ERPM Module Template."
  s.description = "ERPM Module Template."
